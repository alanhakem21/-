# ڕێبەری بەکارهێنان و بڵاوکردنەوەی ماڵپەڕی پەیمانگای پەروەردەی وەرزشی چەمچەماڵ

ئەم بابەتە ڕوونکردنەوەی تەواو دەدات لەسەر چۆنیەتی بڵاوکردنەوەی ماڵپەڕەکە، نوێکردنەوەی لە داهاتوودا، و کۆپی تەواوی کۆدەکانی ئەم پڕۆژەیە.

---

## ١. چۆن لە داهاتوودا ماڵپەڕەکە بڵاوبکەمەوە (بیبەمە سەر ئینتەرنێت - گشتی)؟

بۆ ئەوەی ماڵپەڕەکە ببنە سەر ئینتەرنێت و هەر کەسێک بتوانێت بەستەری (لینک) تایبەت بە خۆی هەبێت، دەتوانیت یەکێک لەم ڕێگایانەی خوارەوە بەکاربهێنیت:

### ڕێگای ئاسان و بێبەرامبەر (Hosting Services):
1. **Netlify یاخود Vercel:**
   - سەرەتا پڕۆژەکە بە شێوەی پاشکۆی **ZIP** دابەزێنە (لەنێو مینیۆی سەرەوەی چاتەکە لای ڕاست یان مینیۆی هەناردەکردن **Export**).
   - پاشان لە Netlify.com بنکەیەک دروست بکە و فایلە دابەزێنراوەکە ڕاستەوخۆ ڕابکێشە (Drag and Drop) بۆ سەر پلاتفۆرمەکە.
   - ماڵپەڕەکەت بە کەمتر لە خولەکێک دەبێتە گشتی و بەستەری تایبەتت پێ دەدات.

2. **GitHub Pages (گیتهەب بۆ نەخشاندنی پرۆژەکان):**
   - پرۆژەکە ڕەوانەی هەژماری گیتهەبی خۆت بکە (لە خزمەتگوزاری مینیۆی ڕێکخستنی AI Studio مینیۆی Export to GitHub هەیە).
   - لە ڕێکخستنی پڕۆژەکەت لە گیتهەب، بەشی **GitHub Pages** چالاک بکە بۆ ئەوەی ڕاستەوخۆ ناونیشانی ماڵپەڕەکەت کار بکات.

---

## ٢. لە کاتی نوێکردنەوەی ماڵپەڕەکەدا چ ڕێکارێک پێویستە؟

ئەگەر لە داهاتوودا ویستت بابەتێک بگۆڕیت، لاببەیت یان قۆناغێکی نوێ زیاد بکەیت:
1. پێویستە دەستکاری فایلی `App.tsx` بکەیت کە لێدراوەتەوە.
2. گۆڕانکاری لە لیستی `stages` بکە لە ناو کۆدەکەدا. بۆ نموونە بۆ قۆناغی سێیەم کە لە ئێستادا بەتاڵە:
   ```typescript
   { id: 'stage-3', title: 'قۆناغی سێیەم', subtitle: 'بەشی سێیەم', items: ['بابەتی نوێ ١', 'بابەتی نوێ ٢'] }
   ```
3. دوای هەر نوێکردنەوەیەک، ئەگەر لە Netlify یان Vercel بەستراوەتەوە بە گیتهەبەوە، بە شێوەیەکی ئۆتۆماتیکی نوێ دەبێتەوە. ئەگەر بە شێوەی دەستی بێت، دووبارە فۆڵدەرە نوێکە (dist) یان هەر پڕۆژەکەکە ڕادەکێشیتەوە.

---

## ٣. کۆپی تەواوی فایلی کۆدی سەرەکی (Source Code)

ئەمەی خوارەوە تەواوی کۆدی فایلی `src/App.tsx`ـە کە لە پڕۆژەکەدا بەکارھاتووە. دەتوانیت بە ئاسانی کۆپی بکەیت یان بەکاری بهێنیتەوە:
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 antialiased font-sans leading-relaxed flex flex-col selection:bg-emerald-500 selection:text-white" dir="rtl">
      ...
      <div className="bg-slate-950 text-slate-350 text-center py-2.5 text-3xs sm:text-xs border-b border-slate-900 tracking-wide font-medium flex items-center justify-center gap-1.5 px-4 shadow-xs">
        ...
        ماڵپەڕی فەرمی پەیمانگای پەروەردەی وەرزشی چەمچەماڵ
      </div>
              ...
              >
                ...
                <div className="p-5 border-b border-slate-100 bg-slate-50/50 rounded-t-2xl">
                  <div className="flex items-center justify-between">
                    ...
                    <Dumbbell className="w-4 h-4 text-emerald-600 opacity-80" />
                  </div>
